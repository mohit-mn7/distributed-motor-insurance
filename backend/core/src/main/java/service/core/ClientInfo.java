...
public class ClientInfo {
    ...
    public boolean equals(Object o) {
        ...
        return getAge() == that.getAge() && getGender() == that.getGender() && getName().equals(that.getName()) && getLicenseNumber().equals(that.getLicenseNumber()) && getNoClaims() == that.getNoClaims() && getPoints() == that.getPoints();
    }
}
