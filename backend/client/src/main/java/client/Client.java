...
public class Client {
    ...
    public static void main(String[] args) {
        for (ClientInfo client : clients) {
            ...
            ClientApplication quotations = restTemplate.postForObject("http://localhost:8080/applications",request, ClientApplication.class);
            displayProfile(quotations.getInfo());
            for(Quotation quotation : quotations.getQuotationList()){
